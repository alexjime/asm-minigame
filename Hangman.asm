...
; 게임 메시지
; caption1 BYTE "Message",0
; WMsg BYTE "Game Clear. Congraturation!",0dh, 0ah

; caption2 BYTE "Message",0
;LMsg BYTE "Game Over. XD You are dead....",0dh, 0ah
;    BYTE "Would you like to replay?",0
